...
export class HandlebarsApplication extends foundry.applications.api.HandlebarsApplicationMixin(
    ...
    // get IS_FORM() {
    //     return this.constructor.IS_FORM;
    // }
    ...
    _initializeApplicationOptions(options) {
        ...
        options.window.title = this.constructor.title ?? `${MODULE_ID}.${this.APP_ID}.title`;
        return options;
    }
    ...
    async _prepareContext(options) {
        ...
        if (this.constructor.IS_FORM) data.buttons = [
            {
                type: "submit",
                action: "submit",
...
export class HandlebarsFormApplication extends HandlebarsApplication {
    ...
    async _onSubmitForm(formConfig, event) {
        ...
        if (formConfig.closeOnSubmit) await this.close({ submitted: true });
    }
